...
import upload_5.form.UploadForm;

@Controller
public class Upload5Controller {
	...
	public void initBinder(WebDataBinder dataBinder) {
	 ...
	 // GET: Hiển thị trang form upload
	   ...
	   public String uploadOneFileHandler(Model model) {
	       ...
	       // Forward to "/WEB-INF/pages/upload1File.jsp".
	       return "upload1File";
	   }
	// POST: Xử lý Upload
	...
	// GET: Hiển thị trang form upload nhiều file
